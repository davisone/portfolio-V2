  ...
  return (
    <section id="accueil" className="min-h-screen flex flex-col justify-between py-12 sm:py-16 lg:py-20">
      <div className="section-container flex-1 flex flex-col justify-center">
        ...
        {/* Social links */}
        <div className="flex items-center gap-4 mt-10 sm:mt-14 animate-fade-in" style={{ animationDelay: '0.5s', animationFillMode: 'backwards' }}>
          <a
      ...
      <a
        href="#apropos"
        className="flex justify-center text-muted hover:text-ink transition-colors mt-8 animate-fade-in"
